...
class Instapag extends StatefulWidget {
  const Instapag({Key? key}) : super(key: key);
  

  @override
  State<Instapag> createState() => _InstapagState();
}

class _InstapagState extends State<Instapag> {
